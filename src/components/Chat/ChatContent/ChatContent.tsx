...
import NewMessageButton from './Message/View/Button/NewMessageButton';
    ...
    <div className='flex-1 overflow-hidden'>
      ...
      >
        ...
        <div className='flex flex-col items-center text-sm dark:new-chat-light'>
          ...
          />
          {error !== '' && (
            <div className='relative py-2 px-3 w-3/5 mt-3 max-md:w-11/12 border rounded-xl border-red-500 bg-red-500/10'>
