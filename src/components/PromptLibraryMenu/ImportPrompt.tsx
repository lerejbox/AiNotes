...
const ImportPrompt = () => {
  ...
  return (
    <div>
      ...
      <input
        className='w-full text-sm file:p-2 text-gray-800 file:text-gray-700 dark:text-gray-300 dark:file:text-gray-200 rounded-xl cursor-pointer focus:outline-none bg-gray-50 file:bg-gray-100 dark:new-chat-light dark:file:new-chat-light file:border-0 border border-gray-300 dark:border-gray-600 placeholder-gray-900 dark:placeholder-gray-300 file:cursor-pointer'
        type='file'
        ref={inputRef}
      />
      <button
      ...
      {alert && (
        <div
          className={`relative py-2 px-3 w-full mt-3 border rounded-xl text-gray-600 dark:text-gray-100 text-sm whitespace-pre-wrap ${
            alert.success
